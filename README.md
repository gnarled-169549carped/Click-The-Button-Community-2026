...
# 🎮 Click the Button — Community Edition

**One button. Endless clicking. Standalone Community Edition.**
...
Click the Button is a minimalist casual clicker game built around a single core mechanic: press the button and watch your stats grow. This Community Edition is a standalone build distributed as a self-contained package that runs entirely offline. No storefront or additional software is required — the game is ready to play immediately after setup.

Players who enjoy minimalist idle and clicker games and want an offline standalone version that runs on any modern PC.
...
<table>
 <tr>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/3946950/1ab98bce8aa28223cdad94b53a0531073bc0e863/ss_1ab98bce8aa28223cdad94b53a0531073bc0e863.1920x1080.jpg?t=1788017433" alt="Screenshot 1" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/3946950/f4a57b545282cd5618db8e2b2e7ac5ded9680cec/ss_f4a57b545282cd5618db8e2b2e7ac5ded9680cec.1920x1080.jpg?t=1788017433" alt="Screenshot 2" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/3946950/46e6dc21fdd4646ec16f3f65094a6e2d45b5ba53/ss_46e6dc21fdd4646ec16f3f65094a6e2d45b5ba53.1920x1080.jpg?t=1788017433" alt="Screenshot 3" width="100%"></td>
 </tr>
</table>
...
- 🖱️ **Single-Button Core** — The entire game revolves around one interactive button with instant click feedback.
- 📈 **Score Progression** — Track cumulative clicks, click rate, and session statistics as you play.
- 🏆 **Milestone Rewards** — Reach defined click thresholds to enable visual feedback and stat markers.
- 💾 **Automatic Saving** — Progress is stored locally after each session; no account is needed.
- 📴 **Fully Offline** — Runs without an internet connection as a self-contained package.
- ⚡ **Lightweight Footprint** — Minimal CPU and memory usage; suitable for older hardware.
- 🎨 **Minimalist Presentation** — A clean interface with nothing distracting from the core mechanic.
- 🚀 **Quick Setup** — Installs in under two minutes and is ready to play immediately.

- **Compression:** Lossless
- **Install Time:** ~1 minute on SSD, ~2 minutes on HDD
- **Recoding:** none
...
| **Processor** | Intel Pentium 4 / AMD Athlon 64 | Intel Core i3 or equivalent |
| **RAM** | 1 GB | 2 GB |
| **Graphics** | Integrated graphics, DirectX 9 compatible | Any DirectX 11 compatible GPU |
| **Storage** | 100 MB available space | 200 MB available space |
| **Additional** | Mouse or touchscreen input | No internet connection required |
...
> 💡 **Saves location:** `%LOCALAPPDATA%\ClicktheButton\Saved`
